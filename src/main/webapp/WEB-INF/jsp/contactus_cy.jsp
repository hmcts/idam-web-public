...
<article class="content__body">
    <a href="javascript:history.back()" class="link-back">Yn ôl</a>
    <h1 class="heading-large">
        Cysylltu â ni
    </h1>

    <h2 class="heading-medium">Ysgariad</h2>
    <ul class="list">
    ...
    <ul class="list">
        <li>E-bost: moneyclaims@justice.gov.uk</li>
        <li>Rhif ffôn: 0300 303 5174</li>
        <li>Dydd Llun i Ddydd Gwener, 9am – 5pm</li>
        <li> <a href="https://www.gov.uk/costau-galwadau">Gwybodaeth am brisiau galwadau</a> </li>
    </ul>
    ...
    <h2 class="heading-medium">Apelio yn erbyn penderfyniad ynghylch budd-daliadau (Cymru a Lloegr)</h2>
    <ul class="list">
    ...
    <h2 class="heading-medium">Apelio yn erbyn penderfyniad ynghylch budd-daliadau (Yr Alban)</h2>
    <ul class="list">
